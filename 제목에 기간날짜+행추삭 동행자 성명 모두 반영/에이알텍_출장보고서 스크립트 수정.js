...
var Integration = Backbone.View.extend({
  ...
  autoSubject : function() {
    ...
    var endDate = moment($(".period input").eq(1).val(), "YYYY-MM-DD"); if(!endDate.isValid()) endDate = today;
    console.log("endDate:", endDate);
  
    // 동행자 성명 (DOM 순서 유지)
    $('.companionName input').each(function () {
