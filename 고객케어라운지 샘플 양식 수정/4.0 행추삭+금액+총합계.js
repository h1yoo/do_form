...
var Integration = Backbone.View.extend({
    ...
    $(".amount input, .unitPrice input, .price input").on("change",function(){
      self.calPrice();
      self.calSumPrice();
  ...
  calPrice : function () {
    ...
    $("#dynamic_table1 tr").each(function(i, e){
      if ($(e).find(".amount")[0]) {
        ...
        var unitPrice = parseInt($(e).find(".unitPrice input").val().replace(/\,/g,"")); if (isNaN(unitPrice)) unitPrice = 0;
        var price = amount * unitPrice || 0;
    ...
    var sum_tax = sum_price * 0.1 || 0;
    var sum_total = sum_price + sum_tax || 0;
    
    $(".sum_price input").val(GO.util.numberWithCommas(sum_price.toFixed(0)));
    $(".sum_tax input").val(GO.util.numberWithCommas(sum_tax.toFixed(0)));
    $(".sum_total input").val(GO.util.numberWithCommas(sum_total.toFixed(0)));
  },
