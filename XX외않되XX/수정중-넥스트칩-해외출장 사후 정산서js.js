...
var Integration = Backbone.View.extend({
	...
	render : function() {
		...
		PlusMinusRow({
          ...
          self.calExWon1(".exchangeRate1 input", ".foreign input", ".calWon");
          self.calSumPrice("#dynamic_table1 .foreign input", "#dynamic_table1 .sum_foreign");
          self.calSumPriceText('#dynamic_table1 .calWon', '#dynamic_table1 .sum_calWon');
          self.calWholeCost();
        },
    ...
    PlusMinusRow({
            ...
            minusRowCallback : function() {self.calSumPrice('#dynamic_table3 .won input', '#dynamic_table3 .sum_won');},
            plusRowCallback : function() {self.calSumPrice('#dynamic_table3 .won input', '#dynamic_table3 .sum_won');}
    });
    ...
    $("#dynamic_table1 .exchangeRate1 input, #dynamic_table1 .foreign input").on("change", function () {
      self.calExWon1(".exchangeRate1 input", ".foreign input", ".calWon");
    ...
    $("#dynamic_table3 .won input").on("change", function () {
      self.calSumPrice('#dynamic_table3 .won input', '#dynamic_table3 .sum_won');
    });
	},
    ...
    var exRate = 0;
		...
		$("#dynamic_table1 tr").each(function(i, e){
            if ($(e).find(foreignPriceValEl)[0]) {
                ...
                var calWon = 0;
                if (foreignPrice == 0 || foreignPrice == "") { calWon = 0; }
                else {
